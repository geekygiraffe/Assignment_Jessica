...
% Answer: for loop - completes loop n times
%         while loop - loops as long as condition is being met
...
% Answer: command why provides a random answer
%{
why
...
sprintf 'Hello World'
%added fun
prompt = 'enter text in single quotation marks:';
Hello_World = input(prompt)
